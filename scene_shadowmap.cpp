...
Scene_Shadowmap::Scene_Shadowmap() : tPrev(0), shadowMapWidth(512), shadowMapHeight(512),
...
void Scene_Shadowmap::initScene()
{
	compile();
...
void Scene_Shadowmap::spitOutDepthBuffer()
{
...
void Scene_Shadowmap::update(float t)
{
...
void Scene_Shadowmap::drawScene()
{
...
void Scene_Shadowmap::setMatrices()
{
	mat4 mv = view * model;
...
void Scene_Shadowmap::resize(int w, int h)
{
	glViewport(0, 0, w, h);
	width = w;
	height = h;
